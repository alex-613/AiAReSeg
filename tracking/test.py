...
def run_tracker(tracker_name, tracker_param, run_id=None, dataset_name='otb', sequence=None, debug=0, threads=0,
    ...
    run_dataset(dataset, trackers, debug, threads, num_gpus=num_gpus, segmentation=segmentation)
...
def main():
    ...
    parser.add_argument('--segmentation', type=bool, default=False, help='Turn on segmentation')
    ...
    run_tracker(args.tracker, args.param, args.id, args.dataset, seq_name, args.debug,
                args.threads, num_gpus=args.gpus, segmentation=args.segmentation)
