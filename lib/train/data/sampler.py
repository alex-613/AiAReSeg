...
class TrackingSampler(torch.utils.data.Dataset):
    ...
    def __init__(self, datasets, p_datasets, samples_per_epoch, max_gap, processing=no_processing, pos_prob=0.5,segmentation=False):
        """
        Args:
    ...
    def getitem(self):
        ...
        while not valid:
            ...
            # plt.imshow(data['search_images'].squeeze(0).permute(1,2,0))
            # plt.show()
